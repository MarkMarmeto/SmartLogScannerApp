    ...
    public UsbQrScannerServiceTests()
    {
        ...
        _scanApiMock
            .Setup(s => s.SubmitScanAsync(
                It.IsAny<string>(), It.IsAny<DateTimeOffset>(), It.IsAny<string>(), It.IsAny<int?>(), It.IsAny<CancellationToken>()))
            .Returns((string payload, DateTimeOffset scannedAt, string scanType, int? cameraIndex, CancellationToken _) =>
