...
|----|-------|--------|-------|---------|--------|
| [EP0001](EP0001-device-setup-and-configuration.md) | Device Setup and Configuration | Draft | Unassigned | 5 | 1.0.0 |
| [EP0002](EP0002-qr-code-scanning-and-validation.md) | QR Code Scanning and Validation | Draft | Unassigned | 3 | 1.0.0 |
| [EP0003](EP0003-scan-processing-and-feedback.md) | Scan Processing and Feedback | Draft | Unassigned | 5 | 1.0.0 |
| [EP0004](EP0004-offline-resilience-and-sync.md) | Offline Resilience and Sync | Draft | Unassigned | 4 | 1.0.0 |
